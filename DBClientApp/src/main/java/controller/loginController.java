    ...
    public void loginHandler(ActionEvent actionEvent) throws SQLException {
        ...
        if (currentUser != null) {
            try {
                ...
                int x = Query.checkUpcomingAppointments(currentUser.getUserID());
                if (x > 0) {
                    Alert alert = new Alert(Alert.AlertType.INFORMATION, "You have " + x + " appointment(s) within 15 minutes");
