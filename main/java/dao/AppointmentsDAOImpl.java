...
public class AppointmentsDAOImpl implements AppointmentsDAO {
    ...
    public Appointment get(int id) throws SQLException {
        ...
        if (rs.next()) {
            ...
            start = TimeConversions.convertUTCToSD(start);
            end = TimeConversions.convertUTCToSD(end);
    ...
    public List<Appointment> getALL() throws SQLException {
        ...
        while (rs.next()) {
            ...
            // convert times to EST and then to systemDefault
//            start = TimeConversions.convertUTCToSD(start);
//            end = TimeConversions.convertUTCToSD(end);

            start = TimeConversions.convertUTCToEST(start);
            end = TimeConversions.convertUTCToEST(end);
            start = TimeConversions.convertESTToSD(start);
            end = TimeConversions.convertESTToSD(end);
//
//            start = TimeConversions.convertUTCToSD(start.atZone(ZoneId.of("UTC")).toLocalDateTime());
//            end = TimeConversions.convertUTCToSD(end.atZone(ZoneId.of("UTC")).toLocalDateTime());
