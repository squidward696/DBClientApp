...
/**
 * controller to manage updating an existing customer and has lambda code
 */
public class UpdateCustController implements Initializable {
    ...
    /**
     * fills each combo box with the appropriate data and contains lambda. use of lambda expression to update divisionComboBox depending
