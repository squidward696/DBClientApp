...
/**
 * controller to manage the "user-view" (main screen)
 */
public class UserController implements Initializable {
    ...
    private void refreshTables() {
        try {
            ...
            //convert appointment times to users time zone
//            for (Appointment appt :
//                    apptData) {
//                appt.setStart(TimeConversions.dateTimeConversion(appt.getStart()));
//                appt.setEnd(TimeConversions.dateTimeConversion(appt.getEnd()));
//            }
    ...
    /**
     * filters appointments by month, week, or all depending on which radio button is selected. use of lambda expression
     * to sort through appointments for desired filter
     *
